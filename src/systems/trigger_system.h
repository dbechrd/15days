...
struct TriggerSystem {
    void Trigger_Audio_PlaySound(Depot &depot, UID subject, MsgType msgType, const char *soundKey, bool override = true);
    void Trigger_Audio_StopSound(Depot &depot, UID subject, MsgType msgType, const char *soundKey);
